...
async function fixture() {
  ...
  for (const name of ['LICENSE', 'apps/web/PROVENANCE.md', 'LICENSES/GPL-3.0-or-later.txt', 'docs/licensing.md',
    'packages/render/GPU_PROVENANCE.md', 'packages/render/GPU_VOXEL_PROVENANCE.md', 'packages/render/GPU_COMBINED_PROVENANCE.md',
    ...
    'packages/render/PROVENANCE.md', 'packages/render/SPRITE_PROVENANCE.md', 'packages/render/VOXEL_PROVENANCE.md', 'packages/sim/MISSION_LOGIC_PROVENANCE.md', 'packages/sim/MISSION_BINDINGS_PROVENANCE.md', 'packages/sim/MISSION_CELL_ENTRY_PROVENANCE.md', 'packages/sim/MISSION_OBJECT_EVENT_PROVENANCE.md', 'packages/sim/MISSION_WORLD_PROVENANCE.md', 'packages/sim/MISSION_HOUSE_PROVENANCE.md', 'packages/content/MISSION_CUES_PROVENANCE.md', 'packages/content/MISSION_AUDIO_PROVENANCE.md', 'packages/content/MISSION_AUDIO_POLICY_PROVENANCE.md', 'packages/formats/MISSION_AUDIO_DECODE_PROVENANCE.md', 'packages/content/INITIAL_WAYPOINTS_PROVENANCE.md', 'packages/sim/WORLD_CONTENT_PROVENANCE.md', 'packages/sim/COMBAT_CONTENT_PROVENANCE.md', 'packages/sim/NATIVE_RANDOM_PROVENANCE.md', 'packages/sim/NATIVE_COMBAT_NUMBERS_PROVENANCE.md', 'packages/sim/ORDINARY_DEATH_PROVENANCE.md', 'packages/sim/ORDINARY_INFANTRY_BRIDGE_PROVENANCE.md', 'packages/sim/INFANTRY_PASSAGE_PROVENANCE.md', 'packages/sim/TEAM_DESTINATIONS_PROVENANCE.md', 'packages/sim/TEAM_RUNTIME_PROVENANCE.md', 'packages/sim/MISSION_TEAM_ACTION_PROVENANCE.md', 'packages/sim/MISSION_TEAM_RUNTIME_PROVENANCE.md', 'packages/sim/MISSION_TEAM_CELL_PROVENANCE.md', 'packages/sim/MISSION_TEAM_ALLOCATION_PROVENANCE.md', 'packages/sim/TEAM_SLEEP_PROVENANCE.md', 'packages/sim/TEAM_RECRUITMENT_PROVENANCE.md', 'packages/sim/TEAM_SPAWN_PROVENANCE.md', 'packages/content/TEAM_ACTIVATION_PROVENANCE.md', 'packages/content/PROVENANCE.md', 'packages/content/CAMPAIGN_LAUNCH_PROVENANCE.md', 'packages/content/OBJECT_ART_PROVENANCE.md', 'packages/content/CONSTRUCTION_PROVENANCE.md', 'packages/content/ENTITY_DEFINITIONS_PROVENANCE.md', 'packages/content/TERRAIN_TRAVERSAL_PROVENANCE.md', 'packages/content/TERRAIN_TRAVERSAL_GROUND_PROVENANCE.md', 'packages/content/FOUNDATION_OCCUPANCY_PROVENANCE.md', 'packages/content/WEAPON_DEFINITIONS_PROVENANCE.md', 'packages/content/VOXEL_RESOURCES_PROVENANCE.md', 'packages/content/TEAM_DEFINITIONS_PROVENANCE.md', 'packages/content/COMBAT_ACTORS_PROVENANCE.md', 'packages/content/COMBAT_DEATH_PROVENANCE.md', 'packages/content/COMBAT_MODIFIERS_PROVENANCE.md', 'packages/content/COMBAT_VETERANCY_PROVENANCE.md', 'packages/content/COMBAT_INITIAL_RUNTIME_PROVENANCE.md', 'packages/sim/INFANTRY_FIRING_PROVENANCE.md', 'packages/content/INSTANT_WEAPONS_PROVENANCE.md', 'packages/content/ANIMATION_EFFECTS_PROVENANCE.md', 'packages/content/INI_SOURCE_PROVENANCE.md', 'packages/content/LOCALE_PROVENANCE.md', 'packages/vfs/PROVENANCE.md', 'packages/vfs/HASH_PROVENANCE.md',
...
test('build emits portable code and notices with a hash manifest, without retail inputs', async () => {
  ...
  try {
    ...
    for(const name of ['GPU_PROVENANCE.md','GPU_VOXEL_PROVENANCE.md','GPU_COMBINED_PROVENANCE.md'])assert.equal(await readFile(join(root,'dist/licenses/packages-render-'+name+'.txt'),'utf8'),await readFile(join(repositoryRoot,'packages/render',name),'utf8'));
    ...
    assert.equal(await readFile(join(root, 'dist/licenses/packages-sim-MISSION_CELL_ENTRY_PROVENANCE.md.txt'), 'utf8'), await readFile(join(repositoryRoot, 'packages/sim/MISSION_CELL_ENTRY_PROVENANCE.md'), 'utf8'));
    assert.equal(await readFile(join(root, 'dist/licenses/packages-sim-MISSION_OBJECT_EVENT_PROVENANCE.md.txt'), 'utf8'), await readFile(join(repositoryRoot, 'packages/sim/MISSION_OBJECT_EVENT_PROVENANCE.md'), 'utf8'));
    assert.equal(await readFile(join(root, 'dist/licenses/packages-sim-MISSION_WORLD_PROVENANCE.md.txt'), 'utf8'), await readFile(join(repositoryRoot, 'packages/sim/MISSION_WORLD_PROVENANCE.md'), 'utf8'));
    assert.equal(await readFile(join(root, 'dist/licenses/packages-sim-MISSION_HOUSE_PROVENANCE.md.txt'), 'utf8'), await readFile(join(repositoryRoot, 'packages/sim/MISSION_HOUSE_PROVENANCE.md'), 'utf8'));
    ...
    assert.equal(await readFile(join(root, 'dist/licenses/packages-content-MISSION_AUDIO_PROVENANCE.md.txt'), 'utf8'), await readFile(join(repositoryRoot, 'packages/content/MISSION_AUDIO_PROVENANCE.md'), 'utf8'));
    assert.equal(await readFile(join(root, 'dist/licenses/packages-formats-MISSION_AUDIO_DECODE_PROVENANCE.md.txt'), 'utf8'), await readFile(join(repositoryRoot, 'packages/formats/MISSION_AUDIO_DECODE_PROVENANCE.md'), 'utf8'));
    assert.equal(await readFile(join(root, 'dist/licenses/packages-content-INITIAL_WAYPOINTS_PROVENANCE.md.txt'), 'utf8'), await readFile(join(repositoryRoot, 'packages/content/INITIAL_WAYPOINTS_PROVENANCE.md'), 'utf8'));
    ...
    assert.equal(await readFile(join(root, 'dist/licenses/packages-sim-MISSION_TEAM_ACTION_PROVENANCE.md.txt'), 'utf8'), await readFile(join(repositoryRoot, 'packages/sim/MISSION_TEAM_ACTION_PROVENANCE.md'), 'utf8'));
    assert.equal(await readFile(join(root, 'dist/licenses/packages-sim-MISSION_TEAM_RUNTIME_PROVENANCE.md.txt'), 'utf8'), await readFile(join(repositoryRoot, 'packages/sim/MISSION_TEAM_RUNTIME_PROVENANCE.md'), 'utf8'));
    assert.equal(await readFile(join(root, 'dist/licenses/packages-sim-MISSION_TEAM_CELL_PROVENANCE.md.txt'), 'utf8'), await readFile(join(repositoryRoot, 'packages/sim/MISSION_TEAM_CELL_PROVENANCE.md'), 'utf8'));
    assert.equal(await readFile(join(root, 'dist/licenses/packages-sim-MISSION_TEAM_ALLOCATION_PROVENANCE.md.txt'), 'utf8'), await readFile(join(repositoryRoot, 'packages/sim/MISSION_TEAM_ALLOCATION_PROVENANCE.md'), 'utf8'));
