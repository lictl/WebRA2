...
async function fixture() {
  ...
  for (const name of ['LICENSE', 'apps/web/PROVENANCE.md', 'LICENSES/GPL-3.0-or-later.txt', 'docs/licensing.md',
    ...
    'packages/render/PROVENANCE.md', 'packages/render/SPRITE_PROVENANCE.md', 'packages/render/VOXEL_PROVENANCE.md', 'packages/sim/MISSION_LOGIC_PROVENANCE.md', 'packages/sim/WORLD_CONTENT_PROVENANCE.md', 'packages/content/PROVENANCE.md', 'packages/content/OBJECT_ART_PROVENANCE.md', 'packages/content/CONSTRUCTION_PROVENANCE.md', 'packages/content/ENTITY_DEFINITIONS_PROVENANCE.md', 'packages/content/TERRAIN_TRAVERSAL_PROVENANCE.md', 'packages/content/INI_SOURCE_PROVENANCE.md', 'packages/content/LOCALE_PROVENANCE.md', 'packages/vfs/PROVENANCE.md', 'packages/vfs/HASH_PROVENANCE.md',
