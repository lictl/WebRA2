...
async function fixture() {
  ...
  for (const name of ['LICENSE', 'apps/web/PROVENANCE.md', 'LICENSES/GPL-3.0-or-later.txt', 'docs/licensing.md',
    ...
    'packages/render/PROVENANCE.md', 'packages/render/SPRITE_PROVENANCE.md', 'packages/render/VOXEL_PROVENANCE.md', 'packages/sim/MISSION_LOGIC_PROVENANCE.md', 'packages/sim/WORLD_CONTENT_PROVENANCE.md', 'packages/sim/COMBAT_CONTENT_PROVENANCE.md', 'packages/sim/NATIVE_RANDOM_PROVENANCE.md', 'packages/sim/NATIVE_COMBAT_NUMBERS_PROVENANCE.md', 'packages/sim/ORDINARY_DEATH_PROVENANCE.md', 'packages/sim/TEAM_DESTINATIONS_PROVENANCE.md', 'packages/sim/TEAM_RUNTIME_PROVENANCE.md', 'packages/sim/TEAM_SLEEP_PROVENANCE.md', 'packages/sim/TEAM_RECRUITMENT_PROVENANCE.md', 'packages/sim/TEAM_SPAWN_PROVENANCE.md', 'packages/content/TEAM_ACTIVATION_PROVENANCE.md', 'packages/content/PROVENANCE.md', 'packages/content/OBJECT_ART_PROVENANCE.md', 'packages/content/CONSTRUCTION_PROVENANCE.md', 'packages/content/ENTITY_DEFINITIONS_PROVENANCE.md', 'packages/content/TERRAIN_TRAVERSAL_PROVENANCE.md', 'packages/content/FOUNDATION_OCCUPANCY_PROVENANCE.md', 'packages/content/WEAPON_DEFINITIONS_PROVENANCE.md', 'packages/content/VOXEL_RESOURCES_PROVENANCE.md', 'packages/content/TEAM_DEFINITIONS_PROVENANCE.md', 'packages/content/COMBAT_ACTORS_PROVENANCE.md', 'packages/content/COMBAT_DEATH_PROVENANCE.md', 'packages/content/COMBAT_MODIFIERS_PROVENANCE.md', 'packages/content/COMBAT_VETERANCY_PROVENANCE.md', 'packages/content/COMBAT_INITIAL_RUNTIME_PROVENANCE.md', 'packages/sim/INFANTRY_FIRING_PROVENANCE.md', 'packages/content/INSTANT_WEAPONS_PROVENANCE.md', 'packages/content/ANIMATION_EFFECTS_PROVENANCE.md', 'packages/content/INI_SOURCE_PROVENANCE.md', 'packages/content/LOCALE_PROVENANCE.md', 'packages/vfs/PROVENANCE.md', 'packages/vfs/HASH_PROVENANCE.md',
