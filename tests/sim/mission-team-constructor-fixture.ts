...
export function constructorFixture(profile: 'ra2' | 'yr', extra = '', script = '0=3,1\n1=50,5', infantry = false, options: { transfers?: boolean; count?: number; subcells?: boolean } = {}) {
