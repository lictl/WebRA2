...
export function teamFixture({profile='ra2' as 'ra2'|'yr', script='0=3,0\n1=6,1', count=1,
  extraTeam='', extraRules='', waypoint='0=3003', extraAI='', extraMap='', speed=128, infantryRows='0=Commander,Walker,256,2,2,0,Guard,0,None\n1=Commander,Walker,256,2,3,0,Guard,0,None\n2=Rival,Walker,256,4,2,0,Guard,0,None'}={}) {
  ...
  return {...input,rules,ai,definitions,compilation:compileTeamProgram(input)};
}
