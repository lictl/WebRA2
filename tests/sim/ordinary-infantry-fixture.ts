...
export function ordinaryFixture({ profile = 'ra2' as 'ra2' | 'yr', sourceFields = '', targetFields = '', weaponFields = '', impactFields = '', artFields = '',
  extraRules = '', rank = '0', overlay = false, elevation = false, sharedTarget = false, seed = 1234, difficulty = 1 as 0 | 1 | 2 } = {}) {
