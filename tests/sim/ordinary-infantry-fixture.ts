...
export function ordinaryFixtureSource({ profile = 'ra2' as 'ra2' | 'yr', sourceFields = '', targetFields = '', targetPrimary = 'Complex', weaponFields = '', impactFields = '', artFields = '',
  extraRules = '', extraMap = '', extraCountries = '', extraHouses = '', sourceTag = 'None', targetTag = 'None', extraInfantryRows = '', damage = 10, rank = '0', targetRank = '0', overlay = false, elevation = false, sharedTarget = false, seed = 1234, difficulty = 1 as 0 | 1 | 2, fireUp = 2, rof = 4, ground = false, ramp = 0, subcells = false } = {}) {
