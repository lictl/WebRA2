...
const en = {
  nav: 'Practice', installation: 'Installation', workspace: 'Workspace', device: 'ON-DEVICE', stage: 'PRACTICE FIELD',
...
const zh: Record<PracticeText, string> = {
  nav: '練習', installation: '遊戲檔案', workspace: '工作區', device: '僅限此裝置', stage: '練習場',
