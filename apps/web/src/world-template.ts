...
export const worldTemplate = `<section class="world-panel" hidden aria-labelledby="world-title">
  ...
  <div class="world-primary-orders"><button id="world-run" class="primary"></button><button id="world-stop" data-world="stop"></button><button id="world-focus" data-world="focus"></button></div>
  <div class="world-operation"><p id="world-notice" role="status" aria-live="polite"></p><button id="world-cancel-replay" data-world="cancelReplay" hidden></button></div>
  ...
  <div class="world-panel-body">
    <section id="world-orders-panel" aria-labelledby="world-open-orders">
      ...
      <div id="world-combat-controls" class="world-combat-controls" hidden><label><span data-world="attackTarget"></span><select id="world-attack-target"></select></label><button id="world-attack" data-world="attack"></button><span id="world-attack-status" role="status" aria-live="polite"></span></div>
