...
export type TerrainReply = { version: 3; id: number; type: 'progress'; sequence: number; progress: TerrainProgress } | { version: 3; id: number; type: 'result'; result: TerrainResult } | { version: 3; id: number; type: 'error'; code: string };
