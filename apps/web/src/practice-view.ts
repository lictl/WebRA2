...
<aside class="sidebar"><a class="brand" href="#setup" aria-label="WebRA2"><span class="brand-mark" aria-hidden="true">W</span><span class="brand-word">WEB<span>RA2</span></span></a><nav class="navigation"><a href="#setup" data-practice-text="installation"></a><a href="#practice" class="current" data-practice-text="nav"></a><a href="#terrain" data-practice-text="terrain"></a></nav><p class="sidebar-footer" data-practice-text="footer"></p></aside>
