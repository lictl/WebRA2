...
| RA2/YR patch/loose/mod/language/theater precedence | IMPLEMENTED explicit ranked profile resolver; native effective precedence unverified | M0–M1 | [Resolver and candidate projection](analysis/profile-resolution.md) preserve ties, profile isolation and provenance; native patch/loose/theater/language policy and full manifests remain [#18](https://github.com/lictl/WebRA2/issues/18) |
...
| Trigger event/action interpreter, tags, variables, timers | IMPLEMENTED structural tag/trigger/event/action reference graph; opcode evidence model SPECIFIED; interpreter NOT_STARTED | M3–M5 | Resolve effective mission closure, execution order/repeat/link semantics and original-game traces |
| ScriptTypes/TaskForces/TeamTypes and campaign AI | IMPLEMENTED structural team/taskforce/script/type graph; AI behavior NOT_STARTED | M3–M5 | Recruitment, scheduling/interruptions, scripted orders, production/base/attack behavior |
| Campaign objectives/outcomes/progression/difficulty | OBSERVED battle/mission table references; runtime NOT_STARTED | M3–M6 | [Table/graph report](analysis/campaign-graph.md) retains variants and unknown progression; every original mission/difficulty, win/loss and optional/alternate paths remain |
