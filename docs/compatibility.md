...
| Trigger event/action interpreter, tags, variables, timers | SPECIFIED evidence/unknown-semantics model; interpreter NOT_STARTED | M3–M5 | Complete mission opcode census, execution order/repeat/link semantics and original-game traces |
| ScriptTypes/TaskForces/TeamTypes and campaign AI | SPECIFIED probe/evidence format; AI NOT_STARTED | M3–M5 | Recruitment, scheduling/interruptions, scripted orders, production/base/attack behavior |
